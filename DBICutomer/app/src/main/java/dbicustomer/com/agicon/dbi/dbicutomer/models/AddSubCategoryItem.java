...
public class AddSubCategoryItem implements Serializable {
    ...
    public AddSubCategoryItem() {
    }

    public AddSubCategoryItem(String new_item_name, String new_item_price, String new_item_quantity, String new_item_total_price,
