...
public class DashboardActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RelativeLayout rel_profile, rel_home, rel_change_password, rel_logout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getApplicationContext().getSharedPreferences(SharedPrefernceValue.MyPREFERENCES, Context.MODE_PRIVATE);
...
//                    .setIcon(R.drawable.dbi_logo)
                    ...
                    .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor.remove(SharedPrefernceValue.REGISTERED_ACCESS_TOKEN);
                            editor.remove(SharedPrefernceValue.LOGIN_ACCESS_TOKEN);
                            editor.clear();
                            editor.apply();
                            editor.commit();
            ...
            intent = new Intent(DashboardActivity.this, GetAllShoppingListActivity.class);
            startActivity(intent);
